    ...
    <div className="mt-20 w-full">
            ...
            <div className="mt-10 w-full">
                ...
                <div className="w-full bg-[#F5F8FB] rounded-[12px] mb-3">
                    <textarea name="resumer" id="" placeholder="Description courte" rows={4} className=" w-full h-full py-[22px] px-[19px] rounded-[18px] focus:border-none focus:outline-0"></textarea>
            ...
            <div className="mt-10 w-full">
                ...
                <div className="w-full bg-[#F5F8FB] rounded-[12px] mb-3">
                    <textarea name="objectifs" id="" placeholder="Objectifs" rows={4} className=" w-full h-full py-[22px] px-[19px] rounded-[18px] focus:border-none focus:outline-0"></textarea>
                    {/* <input type="text" name="price" placeholder="----"  /> */}
                </div>
            </div>
            ...
            <div className="mt-10 w-full">
                ...
                <div className="w-full rounded-[12px] grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-3 gap-4 mb-3">
                    ...
                    <div className="w-[209px] h-[146px] bg-[#F5F8FB] rounded-[12px] flex justify-center items-center">
