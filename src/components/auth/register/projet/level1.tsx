        ...
        <div className="mt-20 w-full">
            ...
            <div className="mt-10 w-full flex flex-col md:flex-row space-x-10">
                <div className="w-full md:w-1/2">
                    ...
                    <div className=" bg-[#F3F5F7] rounded-[12px] mb-3 flex flex-row items-center px-[19px]">
                        ...
                        <select name="catégorie" id="catégorie" className=" w-full h-full py-[22px] rounded-[12px] focus:border-none focus:outline-0">
                ...
                <div className="w-full md:w-1/2">
                    ...
                    <div className="bg-[#F3F5F7] rounded-[12px] mb-3 flex flex-row items-center px-[19px]">
                        {/* <input type="text" name="price" placeholder="----" className=" w-full h-full py-[22px] px-[19px] rounded-[12px] focus:border-none focus:outline-0" /> */}
                        <select name="sous-catégorie" id="sous-catégorie" className=" w-full h-full py-[22px] rounded-[12px] focus:border-none focus:outline-0">
                            <option value="">Sélectionnez</option>
                            <option value="Services">Services</option>
            ...
            <button className="bg-[#23C7ED] px-[34px] py-[16px] mt-48 text-white rounded-full absolute right-0 cursor-pointer hover:scale-105 transition">Continuer</button>
