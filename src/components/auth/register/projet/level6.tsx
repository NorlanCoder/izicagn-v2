        ...
        <div className="mt-20 w-full">
            ...
            <div className="mt-10 w-full">
                ...
                <div className="w-full bg-[#F3F5F7] rounded-[12px] mb-3 flex flex-row items-center">
                    <input type="text" name="investissement" id="investissement" placeholder="----" className=" w-full h-full py-[22px] px-[19px] rounded-[18px] focus:border-none focus:outline-0" />
