...
const Level4 = ({ changeLevel , previousLevel } : { changeLevel: () => void; previousLevel: () => void }) => {
        ...
        <div className="mt-20">
         ...
         <div className="space-y-8">
            ...
            <div className="flex justify-end items-center gap-4 pt-20 bottom-14 right-0">
                    ...
                    <button onClick={previousLevel} className="border-2 border-[#D9DFE7CC] px-[34px] py-[16px] text-black font-semibold rounded-full hover:scale-105 transition">
                         Précédent
                    </button>
