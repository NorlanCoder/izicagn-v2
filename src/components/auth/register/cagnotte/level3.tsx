    ...
    return (
        <div className="mt-20">
            ...
            <div className="flex flex-col md:flex-row justify-center md:justify-end items-center gap-4 pt-14 bottom-14 right-0">
                    <button onClick={previousLevel} className="border-2 border-[#D9DFE7CC] md:px-[34px] px-[15px] md:py-[24px] py-[8px] text-black font-semibold rounded-full hover:scale-105 transition">
                         Précédent
                    </button>

                    <button onClick={changeLevel} className="bg-[#23C7ED] md:px-[34px] px-[15px] md:py-[24px] py-[8px] text-white rounded-full hover:scale-105 transition">
                        Continuer
                    </button>
            </div>
