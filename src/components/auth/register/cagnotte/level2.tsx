    ...
    return (
        <div className="mt-20 flex flex-col justify-center">
            ...
            <div className="flex justify-center md:justify-end items-center gap-4  bottom-14 pt-32 right-0">
                    <button className="border-2 border-[#D9DFE7CC] md:px-[34px] px-[20px] py-[16px] text-black font-semibold rounded-full hover:scale-105 transition">
                         Précédent
                    </button>

                    <button className="bg-[#23C7ED] md:px-[34px] px-[20px] py-[16px] text-white rounded-full hover:scale-105 transition">
                        Continuer
                    </button>
            </div>
