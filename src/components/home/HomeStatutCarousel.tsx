...
const HomeStatutCarousel = () => {
    return (
        <div className='md:w-2/5 w-full bg-[#FEA373] lg:h-[580px] rounded-[40px] overflow-hidden flex flex-col'>
            <div className="px-4 py-5 flex flex-row space-x-2">
            ...
            <div className="md:px-10 px-5">
                ...
                <div className="cursor-pointer md:w-[267px] w-full bg-white h-[52px] flex flex-row justify-center items-center space-x-3 rounded-full mt-2"><span className="text-[#0A1243] font-bold text-[14.53px] montserrat-bold ">Faire un don</span> <div className='bg-[#0A1243] rounded-full w-[19.87px] h-[19.87px] flex justify-center items-center'><ArrowRightIcon className='text-white' size={12}/></div> </div>
            </div>

            <div className="mt-4 flex-grow h-full relative">
                <img src={StatutFrame} alt="" className="w-full h-full absolute bottom-0 left-0" />
            </div>
        </div>
    )
}
