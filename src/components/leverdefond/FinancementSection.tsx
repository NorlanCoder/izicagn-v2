    ...
    return (
        <div className='lg:px-[120px] md:px-[80px] px-[16px] pb-20'>
            ...
            <div className='flex flex-col items-center'>
                ...
                <h2 className='md:max-w-[771px] text-[56px] text-[#0E0E18] font-bold text-center items-center leading-[100%] tracking-[-2px] pb-16'>Pourquoi <span className='text-[#07AED8]'>lever des fonds </span>avec Izicagn ?</h2>
