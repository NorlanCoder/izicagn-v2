...
const FinancementSection = () => {
    return (
        <div className='lg:px-[120px] md:px-[80px] px-[16px] pb-20'>
            <div className='flex flex-col lg:flex-row space-y-10 space-x-10 items-center justify-center py-20'>
                <div className='space-y-[28px]'>
                    ...
                    <div className='flex space-x-[10px] items-start'>
                        <div className='bg-[#FDF6F1] p-3 rounded-full'>
                            <img src={HandShake} alt="" />
                        </div>
                        <p className='text-[17px] text-[#555B6D] font-medium leading-[21px] max-w-[465px]'>izicagn organise la mise en relation et l’intermédiation entre futurs entrepreneurs, projets d’entreprises et investisseurs</p>
                    </div>
                    <div className='flex space-x-[10px] items-start'>
                        <div className='bg-[#FDF6F1] p-3 rounded-full'>
                            <img src={Professional} alt="" />
                        </div>
                        <p className='text-[17px] text-[#555B6D] font-medium leading-[21px] max-w-[465px]'>A travers un accompagnement sur la problématique de la structuration et d’accès au financement par le biais d’<span className='text-[#FD8352] font-bold italic'>entreprises partenaires de conseil</span>.</p>
                    </div>
                    <button className='bg-[#083044] transition-all duration-700 ease-in-out hover:bg-[#07AED8] py-4 px-[30px] rounded-[200px] text-white font-bold'>Financer un projet</button>
                </div>
            ...
            <div className='flex flex-col items-center'>
                ...
                <h2 className='md:max-w-[771px] text-[56px] text-[#0E0E18] font-semibold text-center items-center leading-[100%] tracking-[-2px] pb-16'>Pourquoi <span className='text-[#07AED8]'>lever des fonds </span>avec Izicagn ?</h2>
                <div className='flex flex-wrap justify-center md:space-x-6 space-y-6'>
                    <div className='relative rounded-[30px] max-h-[452px] lg:w-auto w-full px-10 pb-10' id='bg-ldf1'>
                        <img src={Decor1} alt="" className='absolute left-0 object-cover' />
                    ...
                    <div className='relative rounded-[30px] max-h-[452px] lg:w-auto w-full lg:mt-14 px-10 pb-10' id='bg-ldf2'>
                    ...
                    <div className='relative rounded-[30px] max-h-[452px] lg:w-auto w-full px-10 pb-10 md:mr-0' id='bg-ldf3'>
