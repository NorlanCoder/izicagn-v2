    ...
    <section className="w-full h-full">
      <div className="w-full h-[622px] flex justify-center items-start gap-4 mb-8">
        <div
          ...
          className="relative w-[508px] h-[622px] rounded-[30px]"
        >
          <img
            src={avatar_1}
            alt="Avatar"
            className="w-[508px] h-[622px] rounded-[30px] object-cover mix-blend-lighten"
          />
        </div>
        ...
        <div
          ...
          className="w-[60vw] h-full bg-[#033C50] flex flex-col justify-center rounded-[30px] max-w-[705px] max-h-[622px] space-y-8 p-8"
        >
