...
const CagnotteLargeComponent2 = ({item}:CagnotteMediumComponentProps) => {
    ...
    return (
        <div onClick={()=>RedirectToDetailsPage()} id="CagnotteMediumComponent" className='md:w-1/3 w-full h-[] rounded-[16px] px-[13px] pb-[28px] pt-[12px] border border-transparent transition-all hover:border-[#5F6364]/20'>
            ...
            <div>
                <h2 className='flex flex-row flex-nowrap text-black text-[18px] montserrat-bold font-[700] mb-3'>{item.title}</h2>
                ...
                <h3 className="text-[14px] text-[#585D5E] mb-4"> <span className='text-[#07AED8] montserrat-bold font-[700]'>{item.solde} Fcfa</span> collectés</h3>
                <div className='flex flex-row justify-between items-center'>
                    ...
                    <div className='flex flex-row items-center space-x-[8px] '>
                        ...
                        <h4 className='text-[12px] text-[#5F6364] font-[600]'><span className='text-black montserrat-bold'>{item.besoin-item.solde}</span> participants</h4>
                    </div>
                </div>
            </div>
        </div>
...
export default CagnotteLargeComponent2