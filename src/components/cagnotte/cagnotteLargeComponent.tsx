...
const CagnotteLargeComponent = ({item}:CagnotteMediumComponentProps) => {
    ...
    return (
        <div onClick={()=>RedirectToDetailsPage()} id="CagnotteMediumComponent" className='md:w-1/2 w-full h-[] rounded-[16px] px-[13px] pb-[28px] pt-[12px] border border-transparent transition-all hover:border-[#5F6364]/20'>
