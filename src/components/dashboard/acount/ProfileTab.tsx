...
import { TriangleAlert, Camera, User, Download } from "lucide-react";

export default function ProfileTab  () {
  const [accountType, setAccountType] = useState("particulier");

  return (
    <div className="min-h-screen p-6 border-2 border-[#E8EDF2] rounded-xl shadow">
      <div className="">
        ...
        <div className="bg-white space-y-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            {[
              { id: "particulier", label: "Particulier", desc: "Personne physique" },
              { id: "organisation", label: "Organisation", desc: "ONG ou Fondation" },
              { id: "entreprise", label: "Entreprise", desc: "Société commerciale" },
            ].map((type) => (
              <div
                key={type.id}
