      ...
      <div className="mt-[100px] ">
          ...
          <div className="flex flex-col justify-center items-center pb-16">
            <div className="">
              <div className="flex justify-between w-full lg:w-[938px]">
                <h1 className=" text-[40px] lg:text-[54px] font-bold max-w-[640px]">
        ...
        <div className=" rounded-[42.51px] px-4" id="bg-tarif">
          <div className="flex flex-col justify-center items-center py-14">
            <div className="">
              <div className="flex flex-col justify-center items-center">
                <div className="flex justify-between md:items-center w-full lg:max-w-[1012px] pb-10 px-5">
                  <p className="text-[#0C0C44] text-3xl md:text-[48px] font-bold tracking-[-2px] max-w-[538px]">
                    Des <span className="text-blue-500">tarifs simples</span>,
                    pour tous vos objectifs
                  </p>
                  <div className="flex flex-col space-y-4">
                    <p className="text-[#6F7886] uppercase font-bold text-[16px] lg:text-[20px]">
                      Frais izicagn pour
                    </p>
                ...
                <div className="flex flex-col space-x-4 space-y-4 lg:flex-row ">
                  <div className=" bg-white rounded-[40px] border-[#07AED81A] border-4 pl-10 pr-20 pt-10 pb-20 h-[497px] w-[454px]">
                    <img src={Love} alt="" />
                    <p className=" text-[16px] text-[#4E5B6B] font-bold">
                      Aucun frais de démarrage{" "}
                    </p>
                    <p className=" text-[142px] text-[#FD8352]">
                      0<span className=" text-[58.48px]">Fcfa</span>
                    </p>
                    <p className="text-[15px] max-w-[301px]">
                  ...
                  <div className=" bg-white rounded-[40px] border-[#07AED81A] border-4 pl-10 pr-20 pt-10 h-[497px] w-[454px]">
                    ...
                    <p className="text-[142px] text-[#FD8352]">
                      5<span className=" text-[58.48px]">%</span>
                    </p>
                    <p className="text-[15px] max-w-[301px]">
            ...
            <p className=" md:text-[20px] text-white text-center py-4">
        ...
        <div className="flex justify-center py-32 px-4">
          <div className="w-[938px]">
            <h2 className="text-[28px] font-bold pb-9">
