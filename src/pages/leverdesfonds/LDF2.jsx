            ...
            <div className=" px-6">
                ...
                <div className="flex flex-col items-center justify-center">
                    <div className="flex flex-col space-y-8 max-w-[938px] py-20">
                        <p className="text-[#555B6D]">Sur Izicagn, toute personne ayant une idée ou un projet solide peut lever des fonds, que vous soyez un futur entrepreneur cherchant à concrétiser une vision ou un porteur de projet désireux de faire évoluer votre initiative. Les futurs entrepreneurs, qu’ils soient en phase de démarrage ou qu’ils aient déjà une idée bien définie, peuvent utiliser Izicagn pour obtenir le soutien financier nécessaire à la création de leur entreprise. Si vous avez une ambition d’entreprendre mais manquez de moyens, cette plateforme vous permet de créer une cagnotte en ligne et de solliciter le soutien de vos proches, de votre réseau, et même de donateurs sensibilisés par votre idée. Avec Izicagn, vous n’êtes pas seul dans cette aventure. La plateforme propose également des programmes d’accompagnement et des ressources pour vous guider dans chaque étape du financement, en vous assurant de maximiser vos chances de succès.</p>
                        <p className="text-[#555B6D]">Pour les porteurs de projets, qu’il s’agisse de développer un produit, financer une mission sociale ou lancer une initiative communautaire, Izicagn est une solution idéale pour mobiliser les fonds dont vous avez besoin. Vous n’avez pas à être une grande organisation ou disposer d’un réseau déjà constitué pour lever des fonds ici. La plateforme est conçue pour permettre à toute personne, quelle que soit l’ampleur de son projet, de mobiliser sa communauté et au-delà. Vous pouvez être un artiste, un innovateur ou simplement quelqu’un qui souhaite faire une différence dans son environnement. Izicagn vous offre non seulement la visibilité pour atteindre des contributeurs potentiels, mais aussi des outils pour bien structurer votre campagne de collecte. Vous pouvez ainsi suivre vos progrès, interagir avec vos soutiens et rassurer vos contributeurs grâce à des mises à jour régulières sur l’avancement de votre projet. En somme, Izicagn rend le financement participatif accessible, simple et efficace pour tous les profils d’entrepreneurs et porteurs de projets.</p>
                    </div>
                    ...
                    <div className="max-w-[938px] flex flex-col space-y-8 pb-20">
                        <h2 className="text-[36px] font-extrabold">Exigences pour recevoir des fonds</h2>
                        <p className="text-[#555B6D]">Lorem ipsum dolor sit amet consectetur. Tempor quis urna consectetur malesuada rutrum donec cras ultrices. Id suscipit tellus tortor odio volutpat velit est. Vel laoreet eu in porttitor eget auctor quis sed a. Scelerisque eget lacus vel augue suscipit. Turpis faucibus ornare platea ultricies elit massa porttitor adipiscing. Pellentesque eget aliquam ullamcorper pretium pharetra. Varius non quam nisi ac lobortis augue. Enim in id vel leo duis libero enim nulla fermentum. Luctus tellus placerat consequat pulvinar magna accumsan tristique in auctor. Id porttitor lorem commodo dui praesent leo etiam quis.</p>
                        <div>
                            <p className="text-[#555B6D]">Enim elementum blandit tempus eu amet. Nunc vitae quam quam quam egestas neque enim. Facilisi mattis proin amet interdum id neque. Luctus habitant risus pharetra suspendisse sit nibh eu in. Interdum luctus cum id tristique faucibus morbi enim nisi.</p>
                            <p className="text-[#555B6D]">Arcu libero ipsum nulla diam diam augue neque vitae. Dolor platea pharetra eget consectetur aliquam vitae netus arcu. Morbi enim tincidunt imperdiet odio. Mauris faucibus etiam quis eget elementum. Odio et felis enim sit massa. Fermentum a facilisi ligula id tempor tristique aliquam. Mattis blandit nullam integer amet elit in tortor faucibus lacus. Semper vestibulum arcu viverra semper pellentesque pellentesque adipiscing nibh. Risus id venenatis amet etiam semper ullamcorper tristique aenean cras. Vitae dignissim nisi ligula mauris amet.</p>
