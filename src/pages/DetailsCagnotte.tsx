		...
		<div className='px-5 w-full'>
			...
			<section className='md:px-8 mt-8'>
				...
				<div className='flex flex-col lg:flex-row lg:justify-between lg:gap-y-0 lg:space-x-3 gap-y-2 mb-5'>
					<div className='flex flex-col space-y-2 xl:w-9/12 lg:w-8/12'>
						<div className='flex flex-col gap-8 border border-[#D9E8F4] rounded-[17px] p-[40px]'>
							<div>
								<h2 className="text-[20px] font-bold my-3">Présentation</h2>
							...
							<div className='flex items-center justify-between'>
								...
								<div className='flex flex-row items-center gap-2'>
									...
									<p className='text-[14px] text-[#0C0C44] font-bold '>Dénoncer cette cagnotte</p>
								</div>
							</div>
						</div>
						<div className='border border-[#EDEDF3] rounded-[17px] p-[40px]'>
							<h2 className='text-[20px] font-bold pb-14'>Discussions (137avis)</h2>
							<div className='flex flex-col gap-10'>
								<div className='flex flex-col'>
									<div className='flex items-start gap-2'>
										...
										<div className=''>
											...
											<p className=' text-[14px]'>Il y a 3h, <span className=' text-[#07AED8] font-bold'> soutient de 8000 Fcfa</span></p>
								...
								<div className='flex flex-col'>
									<div className='flex items-start gap-2'>
										...
										<div className=''>
											<h3 className='text-[16px] font-bold'>Marie Dansou</h3>
											<p className=' text-[14px]'>Hier<span className=' text-[#07AED8] font-bold'></span></p>
											<p className=' max-w-4xl pt-2 text-[#4E4E4E] text-[16px]'>Lorem ipsum dolor sit amet consectetur. Sit sit vivamus ipsum pharetra sapien 
												eget amet. Integer condimentum sapien amet placerat gravida pellentesque. Dui 
												gravida ut ac feugiat metus. Praesent dis consectetur ut lorem pretium sit sed. 
											</p>
					...
					<div className='flex flex-row space-x-2 self-start xl:w-3/12 lg:w-4/12 w-full'>
						<div className=' pl-8 w-full border border-[#EDEDF3] rounded-[17px] p-[24px]'>
							<h2 className='text-[18px] font-bold my-2'>Dons récents</h2>
